    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cancellation_policy', models.CharField(blank=True, max_length=128, null=True, verbose_name='Política de Cancelamento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_plays', models.BooleanField(verbose_name='Gincanas')),
                ('has_actors', models.BooleanField(verbose_name='Animadores')),
                ('has_generator', models.BooleanField(verbose_name='Gerador de energia')),
                ('has_aircon', models.BooleanField(verbose_name='Ar Condicionado')),
                ('has_handicapped_acess', models.BooleanField(verbose_name='Acessível para deficientes')),
                ('has_wifi', models.BooleanField(verbose_name='Wi-Fi')),
                ('has_valet', models.BooleanField(verbose_name='Manobrista e/ou valet')),
                ('has_acoustics', models.BooleanField(verbose_name='Isolamento acústico')),
