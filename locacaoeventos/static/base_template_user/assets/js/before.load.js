...
$(document).ready(function($) {
    ...
    if( $body.hasClass('navigation-top-header') ) {
        $( ".main-navigation.navigation-top-header" ).load( "/static/base_template_user/assets/external/_navigation.html" );
		navigationStyle = "topHeader";
    }
    else if( $body.hasClass('navigation-off-canvas') ) {
        $( ".main-navigation.navigation-off-canvas" ).load( "/static/base_template_user/assets/external/_navigation.html" );
